...
class Config:
  ...
  max_steps: int = 400000  # The number of optimization steps.
  early_exit_steps: Optional[int] = None  # Early stopping, for debugging.
  checkpoint_every: int = 50000  # The number of steps to save a checkpoint.
  ...
  #************************************************************************************************
  #render_path_file: Optional[str] = 'poses_bounds.npy'  # Numpy render pose file to load.
...
#************************************************************************************************
  #render_spline_keyframes: Optional[str]
  render_spline_keyframes: Optional[str] = None
  #render_spline_keyframes: Optional[str] = 'images_for_spline_path'
  #render_spline_keyframes: Optional[str] = 'spline_image_name.txt'  # Text file containing names of
  # images to be used as spline
  # keyframes, OR directory
  # containing those images.
#************************************************************************************************
  render_spline_n_interp: int = 15 # Num. frames to interpolate per keyframe.

  render_spline_degree: int = 1  # Polynomial degree of B-spline interpolation.
  #************************************************************************************************
