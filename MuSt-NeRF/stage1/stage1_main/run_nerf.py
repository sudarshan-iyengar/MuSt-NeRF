...
def render_video(poses, H, W, intrinsics, filename, args, render_kwargs_test, fps=25):
    ...
    for img_idx in range(len(poses)):
        ...
        with torch.no_grad():
            ...
            rgb, _, _, _ = render(H, W, intrinsic, c2w=pose, **render_kwargs_test)
...
def config_parser():
    ...
    parser.add_argument("--lrate", type=float, default=5e-4,
                        help='learning rate')
    parser.add_argument("--start_decay_lrate", type=int, default=300000,
                        help='start iteration for learning rate decay')
    parser.add_argument("--end_decay_lrate", type=int, default=400000,
